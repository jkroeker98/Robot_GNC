...
HD_PWD='G:/Git_Projects/Robot_GNC/Navigation/Navigation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPS.tcl
