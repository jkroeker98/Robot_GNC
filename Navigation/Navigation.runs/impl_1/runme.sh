...
HD_PWD='G:/Git_Projects/Robot_GNC/Navigation/Navigation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPS.tcl -notrace
